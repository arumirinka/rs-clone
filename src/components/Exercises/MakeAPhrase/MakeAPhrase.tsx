...
const MakeAPhrase = ({
  ...
  const [continueBtnName, setContinueBtnName] = useState(exercisesInterface[appLang].check);
  ...
  const checkPhraseMade = (): void => {
    ...
    setContinueBtnName(exercisesInterface[appLang].continue);
  };

  const showNewWords = () => {
    setContinueBtnDisabled(true);
    setContinueBtnName(exercisesInterface[appLang].check);
    nextWordsLayout();
  ...
  const handleContinueBtnClick = () => {
    if (continueBtnName === exercisesInterface[appLang].check
      && !continueBtnDisabled) {
      checkPhraseMade();
    } else {
      showNewWords();
